        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-slate-400 mb-6 leading-relaxed">
              {siteConfig.tagline}. Building water confidence for families in our community since 2004.
            </p>
            {/* Social */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-sky-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`tel:${siteConfig.phone}`} className="hover:text-sky-400 transition-colors">
                  {siteConfig.phone}
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href={`mailto:${siteConfig.email}`} className="hover:text-sky-400 transition-colors">
                  {siteConfig.email}
                </a>
              </li>
            </ul>
